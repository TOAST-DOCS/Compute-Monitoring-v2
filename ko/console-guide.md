...
>[참고] 알람 발송 횟수에 대하여<br>
> 재부팅 감시 설정을 제외한 모든 지표에 대해서 특정 이벤트에 대한 최초 알람 발송 후, 최대 3회의 추가 알람이 발송될 수 있습니다.<br>
> 10분 경과 알람 발송: 최초 알람 발송 후, 해당 상태가 10분 이상 지속되는 경우<br> 
> 한시간 경과 알람 발송: 최초 알람 발송 후, 해당 상태가 한시간(60분) 이상 지속되는 경우<br> 
